...
public sealed class StartWindow : Window {
    ...
    public StartWindow(AppSession appSession) {
        ...
        ButtonNewMap = BuildActionButton("ButtonNewMap", "New Map", "Create a new map");
        ButtonNewMap.Click += (_, _) => appSession.CreateNewMap(this);
        primaryButtons.Children.Add(ButtonNewMap);

        ButtonImportMap = BuildActionButton("ButtonImportMap", "Import Map", "Import StepMania simfiles");
        ...
        ButtonOpenMap = BuildActionButton("ButtonOpenMap", "Open Map", "Continue working on an existing map");
    ...
    static Button BuildActionButton(string name, string title, string subtitle) {
