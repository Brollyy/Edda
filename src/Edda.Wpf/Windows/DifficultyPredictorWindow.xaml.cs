    ...
    public partial class DifficultyPredictorWindow : Window {
        ...
        private void BtnPredict_Click(object sender, RoutedEventArgs e) {
            ...
            for (int i = 0; i < mapEditor.numDifficulties; i++) {
                ...
                var difficultyMap = mapEditor.GetDifficulty(i);
                var diffPrediction = difficultyMap == null
                    ? 0
                    : mainWindow.difficultyPredictor.PredictDifficulty(difficultyMap.notes, mapEditor.GlobalBPM, mapEditor.SongDuration);
                Label diffLabel;
                Button diffBtn;
                switch (i) {
